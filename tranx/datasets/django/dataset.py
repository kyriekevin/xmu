...
class Django(object):
    ...
    def parse_django_dataset(annot_file, code_file, asdl_file_path, max_query_len=70, vocab_freq_cutoff=10):
        ...
        for idx, (src_query, tgt_code) in enumerate(zip(open(annot_file), open(code_file))):
            ...
            #tgt_actions.reverse() if right_left else None
            #print(tgt_code)
            #for action_data in tgt_actions:
            #    print(idx,action_data)
    ...
    def process_django_dataset():
        ...
        file_name = ""
        if level_traversal:
            file_name = 'data/django/train_teacher.bin'
        elif right_left:
            file_name = 'data/django/train_r2l.bin'
        else:
            file_name = 'data/django/train_student.bin'
