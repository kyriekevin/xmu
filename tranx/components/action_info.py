...
def get_action_infos(src_query, tgt_actions, force_copy=False,level_traversal=False,right_left=False):
    action_infos = []
    hyp = Hypothesis()
    for t, action in enumerate(tgt_actions):
        ...
        hyp.apply_action(action,level_traversal=level_traversal,right_left=right_left)
