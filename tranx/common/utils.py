...
def init_arg_parser():
    ...
    arg_parser.add_argument('--lang', choices=['python', 'lambda_dcs', 'wikisql', 'prolog', 'python3',"ifttt"], default='python',
    ...
    arg_parser.add_argument('--mode', choices=['train', 'test', 'interactive',"result_eval",
                                               'train_paraphrase_identifier', 'train_reconstructor','rerank'], required=True, help='Run mode')

    #### Modularized configuration ####
    arg_parser.add_argument('--traverse_first', type=str, default='deep', required=False, help='')
    arg_parser.add_argument('--parser', type=str, default='default_parser', required=False, help='name of parser class to load')
    arg_parser.add_argument('--parser_student', type=str, default='default_student_parser', required=False, help='name of parser class to load')
    arg_parser.add_argument('--parser_teacher', type=str, default='default_teacher_parser', required=False, help='name of parser class to load')
    ...
    arg_parser.add_argument('--evaluator_student', type=str, default='default_evaluator', required=False, help='name of evaluator class to use')
    arg_parser.add_argument('--evaluator_teacher', type=str, default='default_evaluator', required=False, help='name of evaluator class to use')
    arg_parser.add_argument('--func', type=str, default='KL', required=False, help='a kind of distillation function')
    ...
    arg_parser.add_argument('--is_dir', default=False, action='store_true', help='test all the files of the dir')
    arg_parser.add_argument('--right_left', default=False, action='store_true', help='test all the files of the dir')
    ...
    arg_parser.add_argument('--no_src_dropout', default=False, action='store_true', help='Do not dropout the parent hidden state to update decoder LSTM state')
    ...
    arg_parser.add_argument('--train_student_file', default=None, type=str, help='path to the training target student file', required=False)
    arg_parser.add_argument('--train_teacher_file', default=None, type=str, help='path to the training target teacher file', required=False)
    arg_parser.add_argument('--dev_file', type=str, help='path to the dev source file')
    arg_parser.add_argument('--dev_student_file', type=str, help='path to the student dev source file')
    arg_parser.add_argument('--dev_teacher_file', type=str, help='path to the teacher dev source file')
    arg_parser.add_argument('--pretrain', type=str, help='path to the pretrained model file', required=False)
    arg_parser.add_argument('--pretrain_student', type=str, help='path to the pretrained model file', required=False)
    arg_parser.add_argument('--pretrain_teacher', type=str, help='path to the pretrained model file', required=False)
    ...
    arg_parser.add_argument('--src_dropout', default=0., type=float, help='Dropout rate')
    ...
    arg_parser.add_argument('--lambda_num', default=1.0, type=float, help='weight of mutual learning')
    arg_parser.add_argument('--negative_sample_type', default='best', type=str, choices=['best', 'sample', 'all'])
    arg_parser.add_argument('--vaildate_begin_epoch', default=20, type=int, help='vaildate_begin_epoch')
    ...
    arg_parser.add_argument('--explore_to', default='explore', type=str, help='Save trained model to')
    ...
    arg_parser.add_argument('--gain_init', default=None, type=float,
                            help='If specified, use uniform initialization for all parameters')
    ...
    arg_parser.add_argument('--pretrain_epoch', default=-1, type=int, help='number of pretraining epoches')
    
    arg_parser.add_argument('--optimizer', default='Adam', type=str, help='optimizer')
    arg_parser.add_argument('--optimizer_student', default='Adam', type=str, help='optimizer')
    arg_parser.add_argument('--optimizer_teacher', default='Adam', type=str, help='optimizer')
    ...
    arg_parser.add_argument('--test_student_file', type=str, help='Path to the test file')
    arg_parser.add_argument('--test_teacher_file', type=str, help='Path to the test file')
