...
src_student_dropout=0.5
src_teacher_dropout=0.5
lambda_num=1
model_name=model.geo.seed${seed}.dropout${dropout}.src_dropout${src_dropout}.mutual.encoder.lambda${lambda_num}
...
python -u exp_distillation_share_encoder.py \
    ...
    --vocab ${vocab} \
    --lstm ${lstm} \
    --src_student_dropout ${src_student_dropout} \
    --src_teacher_dropout ${src_teacher_dropout} \
