...
train_teacher_file="data/ifttt/train_r2l.bin"
...
max_epoch=50
lambda_num=0.25
model_name=model.ifttt.seed${seed}.mutual.share.encoder.dropout${dropout}.src_dropout${src_dropout}.lambda${lambda_num}.r2l
