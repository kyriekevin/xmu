...
train_student_file="data/atis/train_teacher.bin"
train_teacher_file="data/atis/train_student.bin"
...
lambda_num=0.5
max_epoch=80
model_name=model.atis.seed${seed}.mutual.no.share.dropout${dropout}.src_dropout${src_dropout}.mutual.lambda${lambda_num}.${traverse_first}.one.way
...
python -u exp_distillation_share_encoder_one_way.py \
    ...
    --pretrain_teacher saved_models/atis/model.atis.baseline.seed${seed}.deep.bin \
